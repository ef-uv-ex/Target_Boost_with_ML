...
dir_DATA = "C:\Users\mattr\OneDrive\Desktop\Target_Boost_with_ML\data\Mini_Arrow";
cd(dir_DATA);
...
tar_cbk = readLintek('miniarrow_mount.bkg');
tar_nocal = readLintek('miniarrow_pec.tar');
